        ...
        >
          ...
          <SheetFooter className="flex-row items-center justify-end gap-3">
            <button
              type="button"
              onClick={onCancel}
              className="h-9 rounded-full border border-border px-4 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground"
            >
              Cancelar
            </button>
            <ButtonSaveDemo label={submitLabel} onClick={onSubmit} className="px-6" />
          </SheetFooter>
        </SheetContent>
      </Sheet>
    )
