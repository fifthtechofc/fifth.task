...
export const JOB_TITLE_DESCRIPTIONS: Record<PredefinedJobTitle, string> = {
  ...
  CTO: "Lidera a visão técnica, arquitetura e qualidade da engenharia, alinhando tecnologia às metas do produto.",
  COO: "Organiza operações e processos internos para escalar entregas com previsibilidade e eficiência.",
  Marketing:
...
export const EXTRA_ROLE_DESCRIPTIONS: Record<string, string> = {
  cto: "Lidera a visão técnica, arquitetura e qualidade da engenharia, alinhando tecnologia às metas do produto.",
  ceo: "Define estratégia e prioridades do negócio, garantindo direção clara e sustentabilidade do workspace.",
  coo: "Organiza operações e processos internos para escalar entregas com previsibilidade e eficiência.",
  cfo: "Cuida da saúde financeira, planejamento e governança dos recursos do negócio.",
  cpo: "Articula visão de produto, roadmap e valor entregue ao usuário em conjunto com as áreas.",
  cmo: "Conduz posicionamento, aquisição e narrativa da marca junto ao mercado e aos clientes.",
  marketing:
    "Conduz posicionamento, aquisição de clientes e estratégias para fortalecimento da marca e comunicação do produto no mercado.",
...
export function getJobTitleDescription(
